            ...
            if conn:
                try:
                    ...
                    try:
                        ...
                        pass
                raise UserError(_("Connection successful to device %s:%s") % (machine_ip, zk_port))
            else:
                raise UserError(_("Unable to connect to Attendance Device %s:%s. Please check IP/Port and network.") % (machine_ip, zk_port))
